...
workbookNamePatternCopy = 'output/Azure-Quote-Tool-{}.xlsx'
...
if os.path.isfile(workbookNamePattern):
    shutil.copyfile(workbookNamePattern, workbookNamePatternCopy.format(today))
...
inputBodyStyleCurr = workbook.add_format({'num_format': 'R$ #,##0.00'})
inputBodyStyleCurr.set_border(1)
inputBodyStyleCurr.set_bg_color('#e6edf6')
...
#PUT DATA FROM APIs
	#VM PAYG
azureVMDataBaseExcelTab.set_column(1, 1, 5)
azureVMDataBaseExcelTab.write(0, 1, 'CPUs', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(2, 2, 9)
azureVMDataBaseExcelTab.write(0, 2, 'Mem(GB)', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(3, 3, 12)
azureVMDataBaseExcelTab.write(0, 3, 'Price/Hour', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(4, 4, 4)
azureVMDataBaseExcelTab.write(0, 4, 'SAP', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(5, 5, 5)
azureVMDataBaseExcelTab.write(0, 5, 'GPU', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(6, 6, 20)
azureVMDataBaseExcelTab.write(0, 6, 'Burstable', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(7, 7, 21)
azureVMDataBaseExcelTab.write(0, 7, 'Region', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(8, 8, 9)
azureVMDataBaseExcelTab.write(0, 8, 'License', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(9, 9, 4)
azureVMDataBaseExcelTab.write(0, 9, 'SSD', inputHeaderStyle)
#azureVMDataBaseExcelTab.set_column(9, 9, 0)
azureVMDataBaseExcelTab.set_column(0, 0, 17)
azureVMDataBaseExcelTab.write(0, 0, 'VM SIZE NAME', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(10, 10, 20)
azureVMDataBaseExcelTab.write(0, 10, 'PRICE BASE 1y -25%', inputHeaderStyle)
azureVMDataBaseExcelTab.set_column(11, 11, 20)
azureVMDataBaseExcelTab.write(0, 11, 'PRICE BASE 3y -25%', inputHeaderStyle)
	#VM 1Y
...
azureVMData1YExcelTab.set_column(5, 5, 20)
...
azureVMData1YExcelTab.set_column(11, 11, 20)
azureVMData1YExcelTab.write(0, 11, 'PRICE RESERVED 1y -5%', inputHeaderStyle)
...
azureVMData3YExcelTab.set_column(5, 5, 20)
...
azureVMData3YExcelTab.set_column(11, 11, 20)
azureVMData3YExcelTab.write(0, 11, 'PRICE RESERVED 3y -5%', inputHeaderStyle)
...
for size in sorted(computePriceMatrix, reverse=True):
    	...
    	#WRITE TO THE BASIC
        #Filtra apenas preços do Brasil
    	if region == "brazil-south":
           	priceBase=float(priceBase)
           	azureVMDataBaseExcelTab.write_number(currentLineBase, 1, cpus,      inputBodyStyle)
           	azureVMDataBaseExcelTab.write_number(currentLineBase, 2, mem,       inputBodyStyle)
           	azureVMDataBaseExcelTab.write_number(currentLineBase, 3, priceBase, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 4, SAP, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 5, GPU, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 6, isBurstable, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 7, region, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 8, license, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 9, ssd, inputBodyStyle)
...
#           	azureVMDataBaseExcelTab.write_formula(currentLineBase, 9, auxFormula, inputBodyStyle)
           	azureVMDataBaseExcelTab.write(currentLineBase, 0, name, inputBodyStyle)
           	#Preço aplicavel para telefonica/vivo em reais com 25% de desconto
           	azureVMDataBaseExcelTab.write_number(currentLineBase, 10,priceBase*730*12*0.75,inputBodyStyleCurr)
           	azureVMDataBaseExcelTab.write_number(currentLineBase, 11,priceBase*730*36*0.75,inputBodyStyleCurr)
           	currentLineBase += 1
           	...
           	if price1Y != 1000000:
           		...
           		#Preço aplicavel para telefonica/vivo em reais com 5% de desconto
           		azureVMData1YExcelTab.write_number(currentLine1Y, 11,price1Y*730*12*0.95,inputBodyStyleCurr)
           		currentLine1Y += 1
           	...
           	if price3Y != 1000000:
           		...
           		azureVMData3YExcelTab.write_number(currentLine3Y, 2, price3Y, inputBodyStyleCurr)
           		...
           		#Preço aplicavel para telefonica/vivo em reais com 5% de desconto
           		azureVMData3YExcelTab.write_number(currentLine3Y, 11,price3Y*730*36*0.95,inputBodyStyleCurr)
           		currentLine3Y += 1
